...
import com.example.indianfood.databinding.FragmentMenuBootomSheetBinding
    ...
    private fun retrieveMenuItems() {
        ...
        foodRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                menuItems = snapshot.children.mapNotNull { foodSnapshot ->
                    snapshot.getValue(MenuItem::class.java)
                }
                setAdapter()
            }
